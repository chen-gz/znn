...
pub fn generateHtmlReport(graph: *Graph, allocator: std.mem.Allocator) ![]const u8 {
    ...
    try html_buf.appendSlice(allocator,
        ...
        \\    const tableNodes = isDecoderLayer 
        \\      ? node._nodes.filter(n => !n.name.endsWith('.residual_attn') && !n.name.endsWith('.output'))
        \\      : node._nodes;
        \\
        ...
        \\        html += `
        \\          <div class="tree-sublayer-block">
        \\            <div class="tree-sublayer-header">
        \\              <span>🔀 Sub-Layer 1: Causal Self-Attention Residual Block</span>
        ...
        \\          <div class="tree-sublayer-block">
        \\            <div class="tree-sublayer-header">
        \\              <span>🔀 Sub-Layer 2: Feed-Forward (MLP) Residual Block</span>
